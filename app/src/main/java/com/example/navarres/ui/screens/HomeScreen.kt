...
fun HomeScreen(viewModel: AuthViewModel) {
    Column(
        modifier = Modifier
            .fillMaxSize()
            .background(Color(0xFFFDFCF0)), // Fondo crema
        verticalArrangement = Arrangement.Center,
        horizontalAlignment = Alignment.CenterHorizontally
    ) {
        // Icono Temático Verde (Huerta)
        Icon(
        ...
        Text(
            text = "Explora los sabores del Reyno",
        ...
        // Info del usuario
        Text(
            text = "Conectado como: ${viewModel.currentUser?.email}",
        ...
        // BOTÓN CERRAR SESIÓN (Abandonar la mesa)
        Button(
